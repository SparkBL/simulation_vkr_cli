...
// PYBIND11_MAKE_OPAQUE(std::map<std::string, Producer *>);
...
PYBIND11_MODULE(rq, m)
{
    ...
    // py::bind_map<std::map<std::string, Producer *>>(m, "ComponentVector");
    ...
    py::class_<Model>(m, "RqModel")
        ...
        .def("add_producer", &Model::AddProducer, "producer"_a, "label"_a)
